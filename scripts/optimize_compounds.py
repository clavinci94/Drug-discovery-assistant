...
def main():
    ...
    ap.add_argument("--seeds", nargs="+", required=True, help="Seed-SMILES (min. 1)")
    ap.add_argument("--mutations", type=int, default=40, help="Mutanten pro Seed (BRICS)")
    ap.add_argument("--topn", type=int, default=50)
    ap.add_argument("--out_csv", default="reports/opt_top.csv")
    ap.add_argument("--out_sdf", default="reports/opt_top.sdf")
    args = ap.parse_args()
